...
class FarmHouseInsuranceResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'image' => asset('storage/images/building_insurance/' . $this->image),
            ...
            'FAQs' => FAQ::where('sub_category_id', config('constant.subcategory.BuildingInsurance'))->get(),

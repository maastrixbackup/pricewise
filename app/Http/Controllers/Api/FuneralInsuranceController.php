...
use App\Http\Resources\FuneralInsuranceResource;
...
class FuneralInsuranceController extends Controller
{
    public function index(Request $request)
    {
        ...
        foreach ($filteredProducts as $product) {
            $formattedProduct = (new FuneralInsuranceResource($product))->toArray($request);
        ...
        $coverages = insuranceCoverage::where('subcategory_id', config('constant.subcategory.FuneralInsurance'))->get();

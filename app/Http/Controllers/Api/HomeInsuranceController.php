...
class HomeInsuranceController extends Controller
{
    public function index(Request $request)
    {
        ...
        $products = InsuranceProduct::where('sub_category',  config('constant.subcategory.HomeInsurance'))->with('postFeatures', 'categoryDetail', 'coverages.coverageDetails', 'providerDetails');

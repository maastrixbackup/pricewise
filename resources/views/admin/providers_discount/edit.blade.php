...
@section('title', 'Pricewise- Provider Discount Update')
@section('content')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.dashboard') }}">
                            Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.provider-discount.index') }}">Provider
                            Discount Upadate</a>
                    </li>
                </ol>
            </nav>
        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form method="post" action="{{ route('admin.provider-discount.update', $sp_discount->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                                ...
                                <select name="provider" class="form-control" id="provider">
                                    ...
                                    @if ($sp_provider)
                                        @foreach ($sp_provider as $item => $val)
                                            <option value="{{ $val->id }}"
                                                {{ $sp_discount->sp_provider == $val->id ? 'selected' : '' }}>
                                                {{ $val->provider_name }}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('provider')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="discount_title" id="discount_title"
                                    value="{{ $sp_discount->title }}" placeholder="Discount Title">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="discount_url" id="discount_url"
                                    value="{{ $sp_discount->slug }}" placeholder="Discount Url" readonly>
                                @error('discount_url')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="discount_type" id="discount_type"
                                    value="{{ $sp_discount->discount_type }}" placeholder="Discount Type" readonly>
                                @error('discount_type')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" name="discount" id="discount"
                                    value="{{ $sp_discount->discount }}" placeholder="Discount">
                                @error('discount')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="datetime-local" class="form-control" name="valid_till" id="valid_till"
                                    value="{{ $sp_discount->valid_till }}" placeholder="Valid Till">
                                @error('valid_till')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <label for="input_type" class=" col-form-label">Status<sup
                                    class="text-danger">*</sup></label>
                            <div class="">
                                <select class="form-control" name="status">
                                    <option value="active" {{ $sp_discount->status == 'active' ? 'selected' : '' }}>Active
                                    </option>
                                    <option value="inactive" {{ $sp_discount->status == 'inactive' ? 'selected' : '' }}>
                                        Inactive</option>
                                </select>
                                @error('status')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>

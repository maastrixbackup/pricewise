            ...
            <div class="tab-content py-3">
                        ...
                        <div class="col-md-12 col-lg-12 col-12">
                            ...
                            <div class="card-body p-4">
                                <form id="productForm2" method="post"
                                    action="{{ route('admin.energy.update', $objEnergy->id) }}"
                                                ...
                                                <div class="card-body p-4">
                                                    <div class=" mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="title"
                                                            ...
                                                            value="{{ $objEnergy->title }}">
                                                    </div>
                                                    <input type="hidden" name="data[gas_consume]" value="200">
                                                    <input type="hidden" name="data[normal_electric_consume]"
                                                        value="500">
                                                    <input type="hidden" name="data[peak_electric_consume]"
                                                        value="500">
                                                    ...
                                                    <div class=" mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="link"
                                                            name="link" readonly value="{{ $objEnergy->slug }}">
                                                        <!-- </div> -->
                                                            ...
                                                            @if ($providers)
                                                                @foreach ($providers as $provider)
                                                                    <option value="{{ $provider->id }}"
                                                                        @if ($objEnergy->provider == $provider->id) selected @endif>
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class=" mb-3">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    ...
                                                                    value="{{ $objEnergy->avg_delivery_time }}"
                                                                    min="0">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                                ...
                                                                <div class="mb-3 add-scroll">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox"
                                                                            ...
                                                                            @if ($objEnergy->transfer_service == 1) checked @endif>
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <select id="contract_length_id" name="contract_type"
                                                                    class="select2 form-select">
                                                                    <option value="month"
                                                                        @if ($objEnergy->contract_type == 'month') selected @endif>
                                                                        Monthly</option>
                                                                    <option value="year"
                                                                        @if ($objEnergy->contract_type == 'year') selected @endif>
                                                                        Yearly</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class=" mb-3">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    ...
                                                                    value="{{ $objEnergy->commission }}" min="0">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class=" mb-3">
                                                                ...
                                                                <select id="commission_type" name="commission_type"
                                                                    class="select2 form-select">
                                                                    <option value="flat"
                                                                        @if ($objEnergy->commission_type == 'flat') selected @endif>
                                                                        Flat</option>
                                                                    <option value="prct"
                                                                        @if ($objEnergy->commission_type == 'prct') selected @endif>
                                                                        Percentage</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="mb-3 add-scroll">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        ...
                                                                        @if ($objEnergy->is_featured == 1) checked @endif>
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            ...
                                                            <div class="mb-3 add-scroll">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        name="no_gas" value="1"
                                                                        @if ($objEnergy->no_gas == 1) checked @endif>
                                                                    <label class="form-check-label"
                                                                        for="flexCheckDefault">No Gas</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card-body p-4">
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <select id="online_status" name="online_status"
                                                            class="select2 form-select">
                                                            <option value="1"
                                                                @if ($objEnergy->status == '1') selected @endif>Publish
                                                            </option>
                                                            <option value="0"
                                                                @if ($objEnergy->status == '0') selected @endif>Draft
                                                            </option>
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <select id="product_type" name="product_type"
                                                            ...
                                                            <option value="personal"
                                                                @if ($objEnergy->product_type == 'personal') selected @endif>Personal
                                                            </option>
                                                            <option value="business"
                                                                @if ($objEnergy->product_type == 'business') selected @endif>Business
                                                            </option>
                                                            <option value="large-business"
                                                                @if ($objEnergy->product_type == 'large-business') selected @endif>Large
                                                                Business</option>
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <select id="meter_type" name="meter_type"
                                                            ...
                                                            <option @if ($objEnergy->meter_type == 'Single Meter') selected @endif>
                                                                Single Meter</option>
                                                            <option @if ($objEnergy->meter_type == 'Double Meter') selected @endif>
                                                                Double Meter</option>
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input type="number" class="form-control" id="no_of_person"
                                                            name="no_of_person" value="{{ $objEnergy->no_of_person }}"
                                                            min="0">
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="category" name="category"
                                                            ...
                                                            @if ($objCategory)
                                                                @foreach ($objCategory as $val)
                                                                    <option value="{{ $val->id }}"
                                                                        @if ($objEnergy->category == $val->id) selected @endif>
                                                                        {{ $val->name }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    ...
                                                    @php
                                                        $energyLabel = $objEnergy->energy_label
                                                            ? json_decode($objEnergy->energy_label)
                                                            : [];
                                                    @endphp
                                                    <label for="input40" class="col-sm-6 col-form-label"><b>Energy Label
                                                        </b></label>
                                                    <div class="col-lg-12">
                                                        <div class="form-check-box">
                                                            <div class="form-group form-check-pr">
                                                                <input type="checkbox" id="a"
                                                                    name="energy_label[]" value="A"
                                                                    @if (is_array($energyLabel) && in_array('A', $energyLabel)) checked @endif>
                                                                <label for="a">A</label>
                                                            </div>
                                                            <div class="form-group form-check-pr">
                                                                <input type="checkbox" id="b"
                                                                    name="energy_label[]" value="B"
                                                                    @if (is_array($energyLabel) && in_array('B', $energyLabel)) checked @endif>
                                                                <label for="b">B</label>
                                                            </div>
                                                            <div class="form-group form-check-pr">
                                                                <input type="checkbox" id="c"
                                                                    name="energy_label[]" value="C"
                                                                    @if (is_array($energyLabel) && in_array('C', $energyLabel)) checked @endif>
                                                                <label for="c">C</label>
                                                            </div>
                                                            <div class="form-group form-check-pr">
                                                                <input type="checkbox" id="d"
                                                                    name="energy_label[]" value="D"
                                                                    @if (is_array($energyLabel) && in_array('D', $energyLabel)) checked @endif>
                                                                <label for="d">D</label>
                                                            </div>
                                                            <div class="form-group form-check-pr">
                                                                <input type="checkbox" id="e"
                                                                    name="energy_label[]" value="E"
                                                                    @if (is_array($energyLabel) && in_array('E', $energyLabel)) checked @endif>
                                                                <label for="e">E</label>
                                                            </div>
                                                            <div class="form-group form-check-pr">
                                                                <input type="checkbox" id="f"
                                                                    name="energy_label[]" value="F"
                                                                    @if (is_array($energyLabel) && in_array('F', $energyLabel)) checked @endif>
                                                                <label for="f">F</label>
                                                            </div>
                                                            <div class="form-group form-check-pr">
                                                                <input type="checkbox" id="g"
                                                                    name="energy_label[]" value="G"
                                                                    @if (is_array($energyLabel) && in_array('G', $energyLabel)) checked @endif>
                                                                <label for="g">G</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="upload_image">
                                                            <img src="{{ asset('storage/images/energy/' . $objEnergy->image) }}"
                                                            ...
                                                            @foreach ($combos as $val)
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        ...
                                                                        @if (in_array($val->id, json_decode($objEnergy->combos))) checked @endif>
                                                                    <label class="form-check-label"
                    ...
                    <form id="internetForm" method="post" action="{{ route('admin.energy.pricing', $objEnergy->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="normal_electric_price"
                                    name="normal_electric_price" placeholder="Normal Electric Price" readonly="readonly"
                                    value="{{ $objEnergy->prices ? $objEnergy->prices->electric_rate : '' }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="input37" class="col-form-label">Off Peak Electric Price/kWh</label>
                                <input type="number" class="form-control" id="peak_electric_price"
                                    name="peak_electric_price" placeholder="Off Peak Electric Price" readonly="readonly"
                                    value="{{ $objEnergy->prices ? $objEnergy->prices->off_peak_electric_rate : '' }}">
                            </div>


                            <div class="col-md-4 mb-3">
                                <label for="input37" class="col-form-label">Normal Feed In Cost/kWh</label>
                                <input type="number" class="form-control" id="normal_feed_in_cost"
                                    name="normal_feed_in_cost" placeholder="Normal Feed In Cost" readonly="readonly"
                                    value="{{ $objEnergy->feedInCost ? $objEnergy->feedInCost->normal_return_delivery : '' }}">
                            </div>


                            <div class="col-md-4 mb-3">
                                <label for="input37" class="col-form-label">Off Peak Feed In Cost/kWh</label>
                                <input type="number" class="form-control" id="peak_feed_in_cost"
                                    name="peak_feed_in_cost" placeholder="Off Peak Feed In Cost" readonly="readonly"
                                    value="{{ $objEnergy->feedInCost ? $objEnergy->feedInCost->off_peak_return_delivery : '' }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="network_cost_gas" class="col-form-label">Network Management Cost Gas</label>
                                <input type="number" class="form-control" id="network_cost_gas" name="network_cost_gas"
                                    placeholder="Network Management Cost Gas" value="{{ $objEnergy->network_cost_gas }}"
                                    min="0">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="input37" class="col-form-label">Network Management Cost Electric</label>
                                <input type="number" class="form-control" id="network_cost_electric"
                                    name="network_cost_electric" placeholder="Network Management Cost Gas"
                                    value="{{ $objEnergy->network_cost_electric }}" min="0">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="delivery_cost_electric" class="col-form-label">Fixed Delivery Cost
                                    Electric</label>
                                <input type="number" class="form-control" id="delivery_cost_electric"
                                    name="delivery_cost_electric" placeholder="Fixed Delivery Cost Electric"
                                    value="{{ $objEnergy->delivery_cost_electric }}" min="0">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="delivery_cost_gas" class="col-form-label">Fixed Delivery Cost Gas</label>
                                <input type="number" class="form-control" id="delivery_cost_gas"
                                    name="delivery_cost_gas" placeholder="Fixed Delivery Cost Gas"
                                    value="{{ $objEnergy->delivery_cost_gas }}" min="0">
                            </div>
                            @php
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="mb-3 add-scroll">
                                    ...
                                    <input class="form-control" type="number" name="government_levies_gas"
                                        value="{{ $objEnergy->government_levies_gas ?? $businessGeneralSettings['governement_levies_gas'] }}"
                                        min="0">
                            ...
                            <div class="col-md-4 col-12">
                                <label for="government_levies_electric" class=" col-form-label">Govt. Levies on
                                    Electric</label>
                                <div class="mb-3 add-scroll">

                                    <input class="form-control" type="number" name="government_levies_electric"
                                        value="{{ $objEnergy->government_levies_electric ?? $businessGeneralSettings['governement_levies_electric'] }}"
                                        min="0">
                            ...
                            <div class="col-md-4 col-12">
                                <div class=" mb-3">
                                    ...
                                    <input type="number" class="form-control" id="reduction_of_energy_tax"
                                        name="reduction_of_energy_tax"
                                        value="{{ $objEnergy->reduction_of_energy_tax ?? $businessGeneralSettings['reduction_of_energy_tax'] }}"
                                        min="0">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="cashback" name="cashback"
                                    placeholder="Cashback" value="{{ $objEnergy->cashback }}" min="0">
                            </div>
                ...
                <div class="tab-pane fade" id="tv" role="tabpanel">
                    ...
                    <form id="tvForm" method="post"
                        action="{{ route('admin.energy_feature_update', $objEnergy->id) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="category_id" value="{{ $objEnergy->category }}">
                        <div class="row">
                                            ...
                                            @if ($parentId && $parentId != 'No Parent')
                                                ...
                                                @if ($features->isNotEmpty())
                                                    ...
                                                    @foreach ($features as $elm)
                                                        @php
                                                            $value = $postEnergyFeatures[$elm->id] ?? [
                                                                'feature_value' => '',
                                                                'details' => '',
                                                            ];
                                                        @endphp
                                                        @if ($elm->input_type == 'text')
                                                            <div class="mb-3">
                                                                <label for="text_{{ $elm->id }}"
                                                                    class="form-label">{{ $elm->features }}</label>
                                                        ...
                                                        @elseif($elm->input_type == 'checkbox')
                                                            <div class="form-check">
                                                                <input type="hidden"
                                                                    name="features[{{ $elm->id }}]" value="0">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="features[{{ $elm->id }}]" value="1"
                                                                    id="check_{{ $elm->id }}"
                                                                    {{ isset($value['feature_value']) && $value['feature_value'] == 1 ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                ...
                <div class="tab-pane fade" id="serviceInfo" role="tabpanel">
                    <form id="infoForm" method="post"
                        action="{{ route('admin.service_info_update', $objEnergy->id) }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="category_id" value="{{ $objEnergy->category }}">
                        <div class="row">
                            <div class="card-header px-4 py-3">

                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if (in_array($val1->id, $data))
                                        <button type="button" value="{{ $val1->id }}" data-productid="{{ $product->id }}" class="uncheck btn btn-sm btn-primary" style="float:right;">Uncheck </button>
                                        @endif
                                        <input class="form-check-input related{{ $val1->id }}" type="radio" name="addon_ids[{{$val->id}}]" value="{{$val1->id}}" <?php if (in_array($val1->id, $data)) {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
                                    ...
                                    @if (in_array($val1->id, $manda_data))
                                                                ...
                                                                @endif
                                        <input class="form-check-input related{{ $val1->id }}" type="radio" name="mandatory_addon_ids[{{ $val->id }}]" value="{{ $val1->id }}" <?php if (in_array($val1->id, $manda_data)) {
                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                } ?>>
                    ...
                    <div class="table-responsive">
                        <table id="catTable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                @php $related = App\Models\ShopProduct::where('category_id', $val->id)->get();
                                @endphp
                                ...
                                <tr>
                                    ...
                                    @if (in_array($val1->id, $data))
                                        <button type="button" value="{{ $val1->id }}" data-productid="{{ $product->id }}" class="uncheck btn btn-sm btn-primary" style="float:right;">Uncheck </button>
                                        @endif
                                        <input class="form-check-input" type="radio" name="related_product_ids[{{$val->id}}]" value="{{$val1->id}}" <?php if (in_array($val1->id, $data)) {
                                                                                                                                                            echo 'checked';
                                                                                                                                                        } ?>>
                                    ...
                                    @if (in_array($val1->id, $manda_data))
                                                                    <button type="button" value="{{ $val1->id }}"
                                                                        ...
                                                                        style="float:right;">Uncheck </button>
                                                                @endif
                                        <input class="form-check-input related{{ $val1->id }}" type="radio" name="mandatory_related_product_ids[{{ $val->id }}]" value="{{ $val1->id }}" <?php if (in_array($val1->id, $manda_data)) {
                                                                                                                                                                                                echo 'checked';
                                                                                                                                                                                            } ?>>

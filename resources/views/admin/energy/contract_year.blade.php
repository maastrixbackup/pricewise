    ...
    <tbody>
        <tr>
            ...
            <td><input type="number" disabled placeholder="Ex:-0.02" value="" readonly class="form-control"
                    name="year_power[1]" id="power_year_1">
            </td>
            <td><input type="number" disabled placeholder="Ex:-0.02" value="" readonly class="form-control"
        ...
        <tr>
            ...
            <td><input type="number" disabled placeholder="Ex:-0.02" value="" readonly class="form-control"
                    name="year_power[2]" id="power_year_2">
            </td>
            <td><input type="number" disabled placeholder="Ex:-0.02" value="" readonly class="form-control"
        ...
        <tr>
            ...
            <td><input type="number" disabled placeholder="Ex:-0.02" value="" readonly class="form-control"
                    name="year_power[3]" id="power_year_3">
            </td>
            <td><input type="number" disabled placeholder="Ex:-0.02" value="" readonly class="form-control"
        ...
        <tr>
            ...
            <td><input type="number" disabled placeholder="Ex:-0.02" value="" readonly class="form-control"
                    name="year_power[4]" id="power_year_4">
            </td>
            <td><input type="number" disabled placeholder="Ex:-0.02" value="" readonly class="form-control"
        ...
        <tr>
            ...
            <td><input type="number" disabled placeholder="Ex:-0.02" value="" readonly class="form-control"
                    name="year_power[5]" id="power_year_5">
            </td>
            <td><input type="number" disabled placeholder="Ex:-0.02" value="" readonly class="form-control"

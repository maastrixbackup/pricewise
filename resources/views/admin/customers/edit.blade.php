            ...
            <div class="card-body p-4">
                <form id="customerForm" method="PUT" action="{{route('admin.customers.update',$objUser->id)}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{$objUser->name}}">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="">
                            <select name="country" id="country" class="select2 form-select">
                                ...
                                <option value="{{ $val->id }}" @if($objUser) {{($objUser->country == $val->id) ? 'selected' : ''}} @endif>{{ $val->country_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <form id="statusForm" method="post" action="{{route('admin.statusChange',$objUser->id)}}">
                    ...
                    <div class="row">
                        ...
                        <div class="">
                            ...
                            <div class="d-md-flex d-grid align-items-center gap-3">
                                <button type="submit" class="btn btn-success px-4" name="submit2">Approve</button>
                            ...
                            <div class="d-md-flex d-grid align-items-center gap-3">
                                <button type="submit" class="btn btn-success px-4" name="approve">Approve</button>

...
@section('title', 'Pricewise- Events Type')
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('admin.events_type.create') }}" class="btn btn-primary">Create a Event Type</a>
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <h6 class="mb-0 text-uppercase">Events ({{ $evs_type->count() }})</h6>
            <hr />
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="eventTable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @if ($evs_type)
                                    @foreach ($evs_type as $val)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $val->title }}</td>
                                            <td><img src="{{ asset('storage/images/event_type/'.$val->image) }}" alt="{{$val->image}}" width="50px" height="50px"></td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <a title="Edit" href="{{ route('admin.events_type.edit', $val->id) }}"
                                                    ...
                                                    <a title="Delete" class="btn1 btn-outline-danger trash remove-category"
                                                        data-id="{{ $val->id }}"
                                                        data-action="{{ route('admin.events_type.destroy', $val->id) }}"><i

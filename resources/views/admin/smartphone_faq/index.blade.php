...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <div class="btn-group">
                <a href="{{ route('admin.smartphone-faq.create') }}" class="btn btn-primary">Create New FAQ</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col d-flex justify-content-evenly">
                                                    ...
                                                    <a title="Edit"
                                                        href="{{ route('admin.smartphone-faq.edit', $record->id) }}"
                                                    ...
                                                    <a title="Delete" class="btn1 btn-outline-danger trash remove-package"
                                                        data-id="{{ $record->id }}"
                                                        data-action="{{ route('admin.smartphone-faq.destroy', $record->id) }}"><i

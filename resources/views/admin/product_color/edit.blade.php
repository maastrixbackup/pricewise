        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form method="post" action="{{ route('admin.product-color.update', $color->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <select name="status" id="status" class="form-control">
                                    <option value="active"{{ $color->status == 'active' ? 'selected' : '' }}>Yes</option>
                                    <option value="inactive"{{ $color->status == 'inactive' ? 'selected' : '' }}>No
                                    </option>
                                </select>
                            </div>
                        </div>

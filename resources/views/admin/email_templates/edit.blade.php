<x-app-layout>
    ...
    <form method="POST" action="{{ route('admin.email-templates.update', $email_template->id) }}" class="row"
            ...
            <div class="imageContainer mb-3 col-md-6">
                ...
                <div class="col-12 form-group">
                    <div>
                        ...
                        <input type="hidden" class="form-control" name="email_of"
                            value="{{ $email_template ? $email_template->email_of : '' }}">
                        <input type="text" class="form-control" placeholder="Email Type"
                            value="@if (isset($email_types[$email_template->email_of])) {{ $email_types[$email_template->email_of] }} @endif"
                            readonly=""> @error('type')
                        ...
                        <div class="email-verify-main">
                            ...
                            <div class="verify-email-inner-box">
                                ...
                                <p class="verify-descrip-data">
                                    ...
                                    the URL below into your web browser: <a
                                        href="#">http://192.168.1.42:8001/verify-email/94/e829fe960232c26d02b5497a65a9feff61daf52a?expires=1665643755&signature=3f48f0024b332717e6fd7646a7154cdf3e1b1f15652aac1809cded7045f0802b</a>
                                </p>
                            </div>

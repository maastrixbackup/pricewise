...
@section('title', 'Pricewise- Product Category Edit')
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form method="post" action="{{ route('admin.product-category.update', $category->id) }}"
                        ...
                        <div class="row mb-3">
                            <label for="input35" class="col-form-label">Image</label>
                        </div>
                        <label for="upload_image" class="mb-3">

                            <img src="{{ asset('storage/images/shops/' . $category->image) }}" id="uploaded_image"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option value="inactive"{{ $category->status == 'inactive' ? 'selected' : '' }}>No
                                    </option>
                                </select>
                            </div>
                        </div>

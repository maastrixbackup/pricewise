...
@section('title', 'Pricewise- Events Room Edit')
@section('content')
        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form method="post" action="{{ route('admin.room_type.update', $edtObj->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Room Type" value="{{ $edtObj->room }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="text" class="form-control" readonly id="url" name="url"
                                    placeholder="Url" value="{{ $edtObj->slug }}">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="input35" class=" col-form-label">Description</label>
                            <textarea class="form-control" name="description" id="description" placeholder="Description">{{ $edtObj->description }}</textarea>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <select name="status" id="status" class="form-control">
                                    <option value="active" {{ $edtObj->status == 'active' ? 'selected' : '' }}>Yes</option>
                                    <option value="inactive" {{ $edtObj->status == 'inactive' ? 'selected' : '' }}>No
                                    </option>
                                </select>
                            </div>
                        </div>

...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('admin.room_type.create') }}" class="btn btn-primary">Create a New Room</a>
                                ...
                                @if ($objRooms)
                                    @foreach ($objRooms as $val)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <a title="Edit" href="{{ route('admin.room_type.edit', $val->id) }}"
                                                    ...
                                                    <a title="Delete" class="btn1 btn-outline-danger trash remove-category"
                                                        data-id="{{ $val->id }}"
                                                        data-action="{{ route('admin.room_type.destroy', $val->id) }}"><i

...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <div class="btn-group">
                <a href="{{ route('admin.deals-product.create') }}" class="btn btn-primary">Create a New Deal</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col d-flex col d-flex justify-content-evenly">
                                                    ...
                                                    <a title="Edit"
                                                        href="{{ route('admin.deals-product.edit', $record->id) }}"
                                                    ...
                                                    <a title="Delete" class="btn1 btn-outline-danger trash remove-package"
                                                        data-id="{{ $record->id }}"
                                                        data-action="{{ route('admin.deals-product.destroy', $record->id) }}"><i

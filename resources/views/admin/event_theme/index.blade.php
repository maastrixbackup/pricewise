...
@section('title', 'Pricewise- Events Theme')
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('admin.event_theme.create') }}" class="btn btn-primary">Create a Event Theme</a>
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <h6 class="mb-0 text-uppercase">Event Theme</h6>
            <hr />
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="themeTable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @if ($ObjThemes)
                                    @foreach ($ObjThemes as $val)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $val->countryDetails->country_name }}</td>
                                            <td><img src="{{ asset('storage/images/event_theme/'.$val->image) }}" alt="{{$val->image}}" width="100px" height="50px"></td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <a title="Edit" href="{{ route('admin.event_theme.edit', $val->id) }}"
                                                    ...
                                                    <a title="Delete" class="btn1 btn-outline-danger trash remove-category"
                                                        data-id="{{ $val->id }}"
                                                        data-action="{{ route('admin.event_theme.destroy', $val->id) }}"><i

            ...
            <div class="card-body p-4">
                <form id="mailSetForm" method="post" action="{{route('admin.smtp-store')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="mail_username" value="{{ $smtpSettings['username'] }}">
                    </div>
                    <div class="mb-3">
                        <label for="password" class="col-form-label">Password</label>
                        <input class="form-control" type="password" name="mail_password" value="{{ $smtpSettings['password'] }}">
                    </div>
                    <div class="mb-3">
                        <label for="encryption" class="col-form-label">Encryption</label>
                        <input class="form-control" type="text" name="mail_encryption" value="{{ $smtpSettings['encryption'] }}">
                    </div>
                    <div class="mb-3">
                        <label for="from_address" class="col-form-label">From Address</label>
                        <input class="form-control" type="text" name="mail_from_address" value="{{ $smtpSettings['from_address'] }}">
                    </div>
                    <div class="mb-3">
                        <label for="from_name" class="col-form-label">From Name</label>
                        <input class="form-control" type="text" name="mail_from_name" value="{{ $smtpSettings['from_name'] }}">
                    </div>

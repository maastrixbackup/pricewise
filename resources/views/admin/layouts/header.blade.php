        ...
        <div>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <ul class="nav-items my-2" id="notDY">
                        <li>
                    ...
                    <div class="p-2 border-top" id="viewNotBtn">
                        <a class="btn btn-alt-primary w-100 text-center" href="{{ route('admin.request_products') }}">
                ...
                <div class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="page-header-user-dropdown">
                    <div class="bg-primary-dark rounded-top fw-semibold text-white text-center p-3">
                        @if (Auth::guard('admin')->user()->profileImage != null || Auth::guard('admin')->user()->profileImage != '')
                            <img src="{{ asset('images/' . Auth::guard('admin')->user()->profileImage) }}" alt="image"
                                id="pImage" class="img-avatar img-avatar48 img-avatar-thumb">
                        @else
                            <img src="{{ asset('assets/media/avatars/avatar10.jpg') }}"
                                class="img-avatar img-avatar48 img-avatar-thumb" alt="user avatar">
                        @endif
                        <!-- <img class="img-avatar img-avatar48 img-avatar-thumb" src="assets/media/avatars/avatar10.jpg" alt=""> -->
                        <div class="pt-2">
                            <a class="text-white fw-semibold"
                                href="be_pages_generic_profile.html">{{ Auth::guard('admin')->user()->name }}</a>
                        </div>
                    </div>
                    <div class="p-2">
                        <a class="dropdown-item"
                            href="{{ route('admin.edit-profile', ['id' => Auth::guard('admin')->user()->id]) }}">
                            <i class="far fa-fw fa-user me-1"></i> Profile
                        </a>
                        <a class="dropdown-item d-flex align-items-center justify-content-between"
                            href="{{ route('admin.change-password', ['id' => Auth::guard('admin')->user()->id]) }}">
        ...
        <div class="content-header">
            <form class="w-100" action="be_pages_generic_search.html" method="POST">
                <div class="input-group">
                    <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
                    <button type="button" class="btn btn-dark" data-toggle="layout"
                        data-action="header_search_off">
                        <i class="fa fa-fw fa-times-circle"></i>
                    </button>
                    <input type="text" class="form-control border-0" placeholder="Search Application.."

...
@section('title', 'PriceWise- Models')
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <div class="btn-group">
                <a href="{{ route('admin.models.create') }}" class="btn btn-primary">Create a Model</a>
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <h6 class="mb-0 text-uppercase">Models</h6>
            <hr />
            <div class="card">
                <div class="card-body">
                                ...
                                @if ($records)
                                    @foreach ($records as $record)
                                        <tr>
                                            ...
                                            <td>{{ $record->name }}</td>
                                            <td>{{ $record->brandDetails->name }}</td>
                                            <td>
                                                <div class="col d-flex gap-2">
                                                    <a title="Edit"
                                                        href="{{ route('admin.models.edit', $record->id) }}"
                                                    ...
                                                    <a title="Delete" class="btn1 btn-outline-danger trash remove-package"
                                                        data-id="{{ $record->id }}"
                                                        data-action="{{ route('admin.models.destroy', $record->id) }}"><i

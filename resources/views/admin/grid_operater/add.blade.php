...
@section('title', 'Pricewise- Operater Create')
@section('content')
        ...
        <div class="col-12 col-lg-10">
            <div class="card">
                <div class="card-header px-4 py-3">
                    <h5 class="mb-0">Add Operaters</h5>
                </div>
                <div class="card-body p-4">
                    <form id="featureFmI" method="post" action="{{ route('admin.grid-operater.store') }}"
                                ...
                                <select name="postal_code[]" class="form-select" id="postal_code" multiple>
                                    ...
                                    @foreach ($postalCodes as $val)
                                        <option value="{{ $val->post_code }}"
                                            {{ old('postal_code') && in_array($val->post_code, old('postal_code')) ? 'selected' : '' }}>
                                            {{ $val->post_code }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <input type="number" step="0.00001" class="form-control" id="current_transport_fee"
                                    ...
                                    value="{{ old('current_transport_fee') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <input type="number" step="0.00001" class="form-control" id="measurment_tariff"
                                    name="measurment_tariff" placeholder="Current Measurement Tariff" value="">

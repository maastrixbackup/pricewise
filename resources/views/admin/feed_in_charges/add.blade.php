...
@section('title', 'Energies - Create Feed In Charges ')
...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <h6 class="mb-0 text-uppercase">Create Feed In Charges </h6>
            <hr />
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('admin.store-feed-in-charges') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <table id="userTable" class="table table-bordered">
                                ...
                                <tbody id="appData">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="range_from[]" value=""
                                                placeholder="Range From" required>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="range_to[]" value=""
                                                placeholder="Range To" required>
                                        </td>
                                        <td>
                                            <input type="number" class="form-control" name="cost_per_day[]" step="0.00001"
                                                value="" placeholder="Cost Per Day" required>
                                        </td>
                                        <td>
                                            <input type="number" class="form-control" name="cost_per_year[]"
                                                step="0.00001" value="" placeholder="Cost Per Year" required>
                                        </td>
                                        <td>
    ...
    <script>
        $(document).ready(function() {
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-danger removeTr"><i
                            class="fa fa-minus-square-o" aria-hidden="true"></i></button>
                </td>
            </tr>`;

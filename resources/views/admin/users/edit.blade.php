    ...
    <div class="col-12 col-lg-8">
        <div class="card">
            ...
            <div class="card-body p-4">
                <form id="userForm" method="PUT" action="{{route('admin.users.update',$objAdmin->id)}}">
                    @csrf
                    <div class="row mb-3">
                        <label for="input35" class="col-sm-3 col-form-label">Name</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{$objAdmin->name}}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="username" name="user_name" placeholder="Username" value="{{$objAdmin->user_name}}" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="input40" class="col-sm-3 col-form-label">Email Address</label>
                        <div class="col-sm-9">
                            <input type="email" class="form-control" id="email" name="email" placeholder="Email Address" value="{{$objAdmin->email}}" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="input36" class="col-sm-3 col-form-label">Phone No</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone No" value="{{$objAdmin->phone_no}}">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <select name="roles[]" id="roles" class="select2 form-select">
                            ...
                            <option value="{{ $role->name }}" @if($objAdmin) {{ $objAdmin->hasRole($role->name) ? 'selected' : '' }} @endif>{{ $role->name }}</option>
                            @endforeach
                        </select>
                        </div>
                    </div>

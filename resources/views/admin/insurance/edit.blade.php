            ...
            <div class="tab-content py-3">
                        ...
                        <div class="col-md-12 col-lg-12 col-12">
                            <div class="card-body p-4">
                                <form id="productForm2" method="post"
                                    action="{{ route('admin.insurance.update', $objTv->id) }}"
                                                ...
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-12">
                                                            <div class=" mb-3">
                                                                <label for="input37" class="col-form-label">Premium
                                                                    Amount</label>
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class=" mb-3">
                                                                <label for="family_extra_amount"
                                                                    class="col-form-label">Extra Per Head Cost</label>
                                                                <input type="number" class="form-control"
                                                                    id="family_extra_amount" name="family_extra_amount"
                                                                    placeholder="Extra Per Head Cost"
                                                                    value="{{ $objTv->family_extra_amount }}"
                                                                    min="0">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class=" mb-3">
                                                                <label for="own_risk" class="col-form-label">Own Risk
                                                                    Amount</label>
                                                                <input type="number" class="form-control" id="own_risk"
                                                                    name="own_risk" placeholder="Own Risk Amount"
                                                                    value="{{ $objTv->own_risk }}" min="0">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class=" mb-3">
                                                                <label for="avg_delivery_time"
                                                                    class=" col-form-label">Average Approval Time</label>
                                                                <input type="number" class="form-control"
                                                                    id="avg_delivery_time" name="avg_delivery_time"
                                                                    placeholder="Average Approval Time"
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class=" mb-3">
                                                                <label for="input40" class=" col-form-label">Premium
                                                                    Interval
                                                                </label>
                                                                <input type="number" class="form-control"
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="mb-3">
                                                                <label for="input40" class="col-form-label">Interval
                                                                    Type</label>
                                        ...
                                        <div class="col-md-3 col-12 col-lg-3">
                                            <div class="card">
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="sub_category" class="col-form-label"><b>Sub
                                                                Category</b>
                                                        </label>
                                                    ...
                                                    <label for="upload_image">
                                                        <img src="{{ asset('storage/images/insurance/' . $objTv->image) }}"
                ...
                <div class="tab-pane fade" id="internet" role="tabpanel">
                    <form id="internetForm" method="post"
                        action="{{ route('admin.insurance_feature_update', $objTv->id) }}">
                        @csrf
                                    ...
                                    @if ($objInternetFeatures)
                                        @foreach ($objInternetFeatures as $elm)
                                            ...
                                            @if ($elm->input_type == 'checkbox')
                                                <div class="form-check">
                                                    <input type="hidden" name="features[{{ $elm->id }}]"
                                                        value="0">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="features[{{ $elm->id }}]" value="1"
                                                        id="check_{{ $elm->id }}"
                                                        @if (isset($value['feature_value']) && $value['feature_value'] == 1) checked @endif>
                                                    <label class="form-check-label"
                ...
                <div class="tab-pane fade" id="tv" role="tabpanel">
                    ...
                    <form id="tvForm" method="post"
                        action="{{ route('admin.insurance_reimburse_update', $objTv->id) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="category_id" value="{{ $objTv->category }}">
                        <input type="hidden" name="sub_category" value="{{ $objTv->sub_category }}">
                                    ...
                                    @if ($objReimburseFeatures)
                                        @foreach ($objReimburseFeatures as $elm2)
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input type="hidden" name="reimburse[{{ $elm2->id }}]"
                                                        value="0">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="reimburse[{{ $elm2->id }}]" value="1"
                                                        id="reimburse_{{ $elm2->id }}"
                                                        @if (isset($value['feature_value']) && $value['feature_value'] == 1) checked @else '' @endif>
                                                    <label for="reimburse_{{ $elm2->id }}"
                                                        class="form-label">{{ $elm2->name }}</label>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class=" mb-3">
                                        ...
                                        <textarea class="form-control" name="active_service_info" id="active_service_info"
                                            placeholder="If Already have a Policy">{{ $serviceInfo[0]->feature_value ?? '' }}</textarea>
                                    </div>

                                    <div class=" mb-3">
                                        <label for="mechanic_service_info" class=" col-form-label">Child Policy
                                            Information</label>
                                        <textarea class="form-control" name="mechanic_service_info" id="active_service_info"
                                            placeholder="Child Policy Information">{{ $serviceInfo[0]->feature_value ?? '' }}</textarea>
                                    </div>

        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('admin.insurance.index') }}">Insurance Products</a></li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class=" mb-3">
                                    <label for="family_extra_amount" class="col-form-label">Family Per Head Extra
                                        Amount</label>
                                    <input type="number" class="form-control" id="family_extra_amount"
                                        name="family_extra_amount" placeholder="Price" min="0">
                                </div>
                            </div>

...
@section('title', 'PriceWise- Loan Types')
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <div class="btn-group">
                <a href="{{ route('admin.loan-type.create') }}" class="btn btn-primary">Create Loan Type</a>
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <h6 class="mb-0 text-uppercase"> Loan Types</h6>
            <hr />
            <div class="card">
                <div class="card-body">
                                ...
                                @if ($loanTypes)
                                    @foreach ($loanTypes as $val)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <a title="Edit" href="{{ route('admin.loan-type.edit', $val->id) }}"
                                                    ...
                                                    <a title="Delete" class="btn1 btn-outline-danger trash remove-category"
                                                        data-id="{{ $val->id }}"
                                                        data-action="{{ route('admin.loan-type.destroy', $val->id) }}"><i

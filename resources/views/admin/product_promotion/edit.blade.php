...
@section('title', 'Pricewise- Promotion Product Edit')
@section('content')
        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form method="post" action="{{ route('admin.product-promotion.update', $promotion->id) }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="sub_title"
                                    value="{{ $promotion->sub_title }}" placeholder="Sub Title">
                                @error('sub_title')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="">
                                <textarea name="description" id="descriptio" class="form-control" placeholder="Description" rows="5">{{ $promotion->description }}</textarea>
                            </div>
                            @error('description')
                                <div class="alert alert-danger mt-1">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="btn_text"
                                    value="{{ $promotion->btn_text }}" placeholder="Ex-Shop now">
                                @error('btn_text')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="btn_url" value="{{ $promotion->btn_url }}"
                        ...
                        <label for="upload_image" class="mb-3">
                            ...
                            <img src="{{ asset('storage/images/shops/' . $promotion->image) }}" id="uploaded_image"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="">
                                <select name="status" id="status" class="form-control">
                                    <option value="active"{{ $promotion->status == 'active' ? 'selected' : '' }}>Yes
                                    </option>
                                    <option value="inactive"{{ $promotion->status == 'inactive' ? 'selected' : '' }}>No
                                    </option>
                                </select>
                            </div>
                        </div>

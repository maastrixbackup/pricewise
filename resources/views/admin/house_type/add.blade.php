...
@section('title', 'Pricewise- House Type Create')
@section('content')
        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                <div class="card-header px-4 py-3">
                    <h5 class="mb-0">Add New House</h5>
                </div>
                <div class="card-body p-4">
                    <form method="post" action="{{ route('admin.house-type.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class=" mb-3">

        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('admin.requests.index') }}">Requests</a></li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <strong>Name:
                                </strong>{{ $userRequest->userDetails ? $userRequest->userDetails->name : '' }}<br>
                                <strong>Address:
                                </strong>{{ $userRequest->userDetails ? $userRequest->userDetails->address : '' }}<br>
                            ...
                            <div class="col-sm-4">
                                ...
                                <strong>Name:
                                </strong>{{ $userRequest->providerDetails ? $userRequest->providerDetails->name : '' }}<br>
                                <strong>Address:
                                </strong>{{ $userRequest->providerDetails ? $userRequest->providerDetails->address : '' }}<br>
                            </div>
                            <div class="col-sm-4">
                                <strong> Order Date: </strong>{{ $userRequest->created_at->format('d/m/Y') }}
                                <strong> Order No: </strong>{{ $userRequest->order_no }}
                                <form action="{{ route('admin.request.update_status', [$userRequest->id]) }}"
                                    id="update_status">
                                    @csrf
                                        ...
                                        <div class="col-sm-9">
                                            <select id="request_status" name="request_status" class="select2 form-select">
                                                ...
                                                <option value="Under Process"
                                                    @if ($userRequest->request_status == 'Under Process') selected @endif>Under Process</option>
                                                <option value="Completed" @if ($userRequest->request_status == 'Completed') selected @endif>
                                                    Completed</option>
                                                <option value="Cancelled" @if ($userRequest->request_status == 'Cancelled') selected @endif>
                                                    Cancelled</option>
                                            </select>
                                        </div>
                                        <div class="d-md-flex d-grid align-items-center gap-3">
                                            <button type="submit" id="submitBtn4" class="btn btn-sm btn-primary px-2"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title d-flex justify-content-between">
                                            Your Subscription
                                            <a class="collapsed" data-toggle="collapse" href="#priceBreakdown"
                                                aria-expanded="false" aria-controls="priceBreakdown">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <p class="mb-0">
                                                    {{ $userRequest->service ? $userRequest->service->title : '' }}</p>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <small class="text-muted">12 months cost €
                                                    {{ $userRequest->total_price }}</small>
                                            </div>
                                        </div>

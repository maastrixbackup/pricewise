...
@section('title', 'Price Compare- Page Edit')
@section('content')
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="card-body p-4">
                                ...
                                <form method="post" action="{{ route('admin.pages.update', $page->slug) }}"
                                    id="featureForm" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <img src="" id="profile-pic" src="{{ $page->image }}">
                                        <div class="mb-3">
                                            <input type="file" class="form-control" name="image" id="button-image"
                                                accept="image/*">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class=" col-form-label">Description</label>
                                        <textarea type="text" rows="9" placeholder="description" name="description" id="description">{!! $page->description !!}</textarea>
                                    </div>
                                    <div class="row mb-3">

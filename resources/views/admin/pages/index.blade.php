            ...
            <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                ...
                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                    <div class="col">
                                        ...
                                        <a title="Edit" href="{{route('admin.pages.edit',$page->slug)}}" class="btn1 btn-outline-primary"><i class="bx bx-pencil me-0"></i></a>
                                        @endif
                                        @if(Auth::guard('admin')->user()->can('page-delete'))
                                        <a title="Delete" class="btn1 btn-outline-danger trash remove-category" data-id="{{ $page->id }}" data-action="{{route('admin.pages.destroy', $page->id)}}"><i class="bx bx-trash me-0"></i></a>
                                        @endif
                                    </div>

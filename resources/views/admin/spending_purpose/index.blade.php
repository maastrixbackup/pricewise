...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <div class="btn-group">
                <a href="{{ route('admin.purposes.create') }}" class="btn btn-primary">New Spending Purpose</a>
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <h6 class="mb-0 text-uppercase"> Spending Purpose</h6>
            <hr />
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="userTable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @if ($objSpending)
                                    @foreach ($objSpending as $val)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $val->name }}</td>
                                            <td><img src="{{ asset('storage/images/loans/' . $val->image) }}"
                                                    alt="{{ $val->image }}" width="60px" height="60px"></td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <a title="Edit" href="{{ route('admin.purposes.edit', $val->id) }}"
                                                    ...
                                                    <a title="Delete" class="btn1 btn-outline-danger trash remove-category"
                                                        data-id="{{ $val->id }}"
                                                        data-action="{{ route('admin.purposes.destroy', $val->id) }}"><i

...
@section('title', 'Pricewise- Energy Regulatory')
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a type="button" href="{{ route('admin.add-regulatory') }}" class="btn btn-primary">
                    Add Regulatory
                </a>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <h6 class="mb-0 text-uppercase">Energy Regulatories</h6>
            <hr />
            <div class="card">
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col">
                                                    ...
                                                    <a title="Edit" href="{{ route('admin.edit-regulatory', $reg->id) }}"
                                                        class="btn1 btn-outline-primary"><i
                                                            class="bx bx-pencil me-0"></i></a>


                                                    <a title="Delete"
                                                        href="{{ route('admin.delete-regulatory', $reg->id) }}"

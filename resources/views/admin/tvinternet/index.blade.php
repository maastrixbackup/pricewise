...
@section('title', 'Pricing - Internet & Tv')
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            {{-- @if (Auth::guard('admin')->user()->can('tv-product-add')) --}}
            <div class="btn-group">
                {{-- <a href="{{route('admin.imports.create')}}" class="btn btn-secondary">Import</a> --}}
                <a href="{{ route('admin.internet-tv.create') }}" class="btn btn-primary">Create New Internet & Tv</a>
            </div>
            {{-- @endif --}}
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <h6 class="mb-0 text-uppercase">Internet & Tv </h6>
            <hr />
            <div class="card">
                <div class="card-body">

...
@section('title','NoPlan- Permission Create')
@section('content')
			...
			<div class="card">
				...
				<div class="card-body p-4">
					<div class="row mb-3">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="name" id="name" class="form-control @error('name') form-control-error @enderror" placeholder="Permission name" value="{{ old('name') }}" required>

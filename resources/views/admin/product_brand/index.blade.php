...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <div class="btn-group">
                <a href="{{ route('admin.product-brands.create') }}" class="btn btn-primary">Create a Brand</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col d-flex col d-flex justify-content-evenly">
                                                    <a title="Edit"
                                                        href="{{ route('admin.product-brands.edit', $record->id) }}"
                                                    ...
                                                    <a title="Delete" class="btn1 btn-outline-danger trash remove-package"
                                                        data-id="{{ $record->id }}"
                                                        data-action="{{ route('admin.product-brands.destroy', $record->id) }}"><i

    ...
    class a {
        static initDataTables() {
            jQuery.extend(jQuery.fn.dataTable.ext.classes, {
                ...
                dom: {
                    button: {
                        className: "btn btn-sm btn-primary me-1 p-2"
                    }
                }
                ...
                autoWidth: !1,
                 buttons: [
                    ...
                    {
                        extend: 'csv',
                        text: '<i class="fa-solid fa-2x fa-file-csv"></i>',
                        titleAttr: 'CSV'
                    },
                    {
                        extend: 'excel',
                        text: '<i class="fa-regular fa-2x fa-file-excel"></i>',
                        titleAttr: 'Excel'
                    },
                    {
                        extend: 'pdf',
                        text: '<i class="fa-regular fa-2x fa-file-pdf"></i>',
                        titleAttr: 'PDF'
                    },
                    {
                        extend: 'print',
                        text: '<i class="fa-solid fa-2x fa-print"></i>',
                        titleAttr: 'Print'
                    }
                ],
